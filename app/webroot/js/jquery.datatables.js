	...
	$.extend( DataTable.ext.oPagination, {
		...
		"full_numbers": {
			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				oSettings.oApi._fnBindAction( nFirst, {action: ""},    fnClickHandler );
				oSettings.oApi._fnBindAction( nPrev,  {action: ""}, fnClickHandler );
				oSettings.oApi._fnBindAction( nNext,  {action: ""},     fnClickHandler );
				oSettings.oApi._fnBindAction( nLast,  {action: ""},     fnClickHandler );
