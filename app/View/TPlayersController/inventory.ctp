...
<section class="inventory_page"> 
	...
	<div class="col right col_2_3">
		...
		<section>
			...
			<div class="inv-inv inv-box">

			<table class="inv-table inv-table1">
				<tr>
					<td data-pos="9">
						<div><div>
		...
		<div class="inv-trash inv-box ui-snap"></div>
...
$(' .inv-table div div').draggable({ revert: "invalid", appendTo: 'body' });
$( ".ui-snap" ).droppable({
			activeClass: "inv-drop-active",
			hoverClass: "inv-drop-hover",
			drop: function( event, ui ) {
				
				var item		= $(ui.draggable).children('img').data('item');
				var position  	= $(ui.draggable).children('img').data('pos');

				var url 		= './tplayers/inventory_delete/'+name+'/'+position;

				//delete the image via  a GET call
			    $.get(url, function() {
