...
<a href="./tworlds/setTime/<?php echo $wrld; ?>/0700" class="button icon clock ajax_table1" onclick="$.colorbox.close();"><?php echo __('Sunrise'); ?></a>
<a href="./tworlds/setTime/<?php echo $wrld; ?>/1200" class="button icon clock ajax_table1" onclick="$.colorbox.close();"><?php echo __('Noon'); ?></a>
<a href="./tworlds/setTime/<?php echo $wrld; ?>/2100" class="button icon clock ajax_table1" onclick="$.colorbox.close();"><?php echo __('Sunset'); ?></a>
<a href="./tworlds/setTime/<?php echo $wrld; ?>/0200" class="button icon clock ajax_table1" onclick="$.colorbox.close();"><?php echo __('Midnight'); ?></a>
</span>
...
<form id="setTimeForm" class="bw11" method="post" action="./tworlds/setTime">
    ...
    <input type="submit" class="button big primary submit bw11" onclick="$.colorbox.close();" value="<?php echo __('Set'); ?>">
</form>
</center></div>
<div class="clear"></div>
</section>
