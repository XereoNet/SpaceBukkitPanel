...
END;
    ...
    */
    ...
    $files = filelist(WWW_ROOT."themes/",1,1); // call the function
    $current_theme = $this->Session->read('current_theme');
    foreach ($files as $list) {//print array
        ...
        echo <<<END
          ...
          <tr>
            ...
            <td><img src="$this->webroot/themes/$list[name]/thumbnail.png" width="100px" height="50px" /></td>
...
END;
        ...
        echo <<<END
              <span class="button-group"><a href="./tsettings/update_theme/$tname" class="button icon approve">Activate</a></span>
